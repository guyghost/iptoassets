...
<div class="min-h-screen bg-[#f7f7f8]">
  <div class="mx-auto max-w-[1400px] px-4 md:px-6 py-8">
    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
      ...
      <button class="flex items-center gap-2 rounded-xl bg-[var(--color-primary-600)] px-5 py-2.5 text-sm font-medium text-white shadow-[var(--shadow-card)] transition-colors hover:bg-[var(--color-primary-700)]">
    ...
    <!-- Stats Row -->
    <div class="mt-6 grid grid-cols-2 gap-2 md:grid-cols-4 md:gap-4">
      <div class="rounded-2xl border border-[var(--border-color)] bg-white px-5 py-4 shadow-[var(--shadow-card)]">
      ...
      <div class="rounded-2xl border border-amber-200 bg-amber-50/50 px-5 py-4 shadow-[var(--shadow-card)]">
      ...
      <div class="rounded-2xl border border-emerald-200 bg-emerald-50/50 px-5 py-4 shadow-[var(--shadow-card)]">
      ...
      <div class="rounded-2xl border border-red-200 bg-red-50/50 px-5 py-4 shadow-[var(--shadow-card)]">
                ...
                <tr class="border-b border-[var(--border-color)] last:border-0 hover:bg-[var(--color-neutral-50)]">
                  ...
                  <td class="py-3.5 text-right">
                    <div class="flex items-center justify-end gap-2">
                      ...
                      <button aria-label="Download" class="rounded-full border border-[var(--border-color)] px-3 py-1 text-xs font-medium text-[var(--color-neutral-600)] hover:bg-[var(--color-neutral-50)] hover:text-[var(--color-neutral-800)]">
