...
<div class="mx-auto max-w-[1400px] px-4 md:px-6 pb-12">
  ...
  {:else}
    ...
    <div class="grid grid-cols-2 gap-2 md:gap-4 lg:grid-cols-4">
      ...
      <div class="rounded-2xl border border-emerald-200 bg-white p-6 shadow-[var(--shadow-card)]">
        <div class="flex items-center gap-2.5">
      ...
      <div class="rounded-2xl border border-indigo-200 bg-white p-6 shadow-[var(--shadow-card)]">
        <div class="flex items-center gap-2.5">
          ...
          <div class="rounded-2xl border border-[var(--border-color)] bg-white p-6 shadow-[var(--shadow-card)]">
            ...
            <div class="mt-4 flex flex-col">
              {#each pendingItems as item}
                ...
                <div class="flex items-start gap-4 border-b border-[var(--border-color)] py-4 last:border-b-0 border-l-2 border-l-amber-400 pl-4 min-h-[var(--touch-target-min)]">
          ...
          <div class="rounded-2xl border border-[var(--border-color)] bg-white p-6 shadow-[var(--shadow-card)]">
            ...
            <div class="mt-4 flex flex-col">
              {#each renewedItems as item}
                {@const scoreColor = getScoreColor(item.score ?? 0)}
                <div class="flex items-start gap-4 border-b border-[var(--border-color)] py-4 last:border-b-0 border-l-2 border-l-emerald-400 pl-4 min-h-[var(--touch-target-min)]">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 flex-wrap">
                      <a href="/assets/{item.assetId}" class="text-sm font-medium text-[var(--color-neutral-900)] hover:text-[var(--color-primary-600)] hover:underline">{item.assetTitle ?? "Untitled Asset"}</a>
                      {#if item.assetJurisdiction}
          ...
          <div class="rounded-2xl border border-[var(--border-color)] bg-white p-6 shadow-[var(--shadow-card)]">
            ...
            <div class="mt-4 flex flex-col">
              {#each abandonedItems as item}
                {@const scoreColor = getScoreColor(item.score ?? 0)}
                <div class="flex items-start gap-4 border-b border-[var(--border-color)] py-4 last:border-b-0 border-l-2 border-l-[var(--color-neutral-300)] pl-4 min-h-[var(--touch-target-min)]">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 flex-wrap">
                      <a href="/assets/{item.assetId}" class="text-sm font-medium text-[var(--color-neutral-900)] hover:text-[var(--color-primary-600)] hover:underline">{item.assetTitle ?? "Untitled Asset"}</a>
                      {#if item.assetJurisdiction}
          ...
          {:else}
            <div class="mt-4 flex flex-col">
              {#each filteredDecisions as item}
                ...
                <div class="flex items-start gap-4 border-b border-[var(--border-color)] py-4 last:border-b-0 border-l-2 pl-4 min-h-[var(--touch-target-min)] {borderColor}">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 flex-wrap">
                      <a href="/assets/{item.assetId}" class="text-sm font-medium text-[var(--color-neutral-900)] hover:text-[var(--color-primary-600)] hover:underline">{item.assetTitle ?? "Untitled Asset"}</a>
                      {#if item.assetJurisdiction}
